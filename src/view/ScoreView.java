...
public class ScoreView extends javax.swing.JDialog {
    
    private DisposeScore sub;
    
    public ScoreView(java.awt.Frame parent, double nilai) {
        super(parent);
        initComponents();
    ...
    public void setSub(DisposeScore sub) {
        this.sub = sub;
    }
