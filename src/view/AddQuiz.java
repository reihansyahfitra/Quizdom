...
public class AddQuiz extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Quiz q = new Quiz(this.dosen.getNip(), 1, this.jTextField3.getText());
        Database.addQuiz(q);
        AddQuestion add = new AddQuestion(q, Integer.valueOf(this.jTextField1.getText()));
        add.setVisible(true);
